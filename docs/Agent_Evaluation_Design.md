...
阅读说明（2026-09-23）：本文包含长期容量与发布体系设计，不表示均已实现，也不作为近期凑题目标。当前实际资产、文件导航与工作顺序见[评测集导航](Agent_Evaluation_Guide.md)，详细状态见[真实Golden建设清单](Agent_Evaluation_Real_Golden.md)。
