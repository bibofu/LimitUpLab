...
class SystemHealthTest(unittest.TestCase):
    # Regression scenario: after close expects today on weekday.
    ...
    # Regression scenario: before close expects previous weekday.
    ...
    # Regression scenario: weekend expects previous friday.
