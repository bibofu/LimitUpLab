...
HANDLERS: MappingProxyType[str, Handler] = MappingProxyType({
    ...
    "strategy_catalog": post_limit.catalog,
    "strategy_latest": post_limit.latest,
    "strategy_stock_path": post_limit.strategy_stock_path,
    "strategy_statistics": post_limit.registered_statistics,
