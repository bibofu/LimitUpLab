...
def _tool_planner_system_prompt(
    ...
    *,
    ...
    return (
        ...
        "For a theme or industry inside the local limit-up pool, call limit_up_events. When the user asks which recent sectors contain more limit-up stocks, use limit_up_events with recent_trade_days and group_by; do not substitute whole-market sector performance. For whole-market industry ranking or a named industry/concept performance, call sector_performance and state its source, data_as_of and freshness. "
