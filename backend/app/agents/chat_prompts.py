...
def _tool_planner_system_prompt(
    ...
    *,
    ...
    return (
        ...
        "For scoring weights, autonomous learning, Champion, or Challenger questions, call scoring_policy_status. "
        "For questions about which post-limit strategies exist, what they study, their versions, maturity or output type, call strategy_catalog. "
        "Strategy answers must state the registered strategy version, data cutoff, limit-up anchor where applicable, maturity and output nature. The Agent may only query, filter, explain, compare and review registered results: never create an ad-hoc score, change weights, register a Challenger or claim an exploratory observation pool is a probability forecast. "
